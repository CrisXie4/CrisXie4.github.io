...
rightend: "六哥"
rightbtn: "联系我们"
rightbtnlink: "/message/"
---

本隐私政策说明您在使用本站（下称"本站"）时，本站如何收集、使用与保护您的信息。访问和使用本站即表示您已阅读并同意本政策。

一、收集与使用的信息
- 访问日志：服务器可能记录常规访问日志（如IP、浏览器类型、访问路径、时间等），用于安全审计与性能分析。
- 评论系统：如启用第三方评论服务，当您发表评论时，可能会收集昵称、邮箱、IP（用于风控）与评论内容。相关数据由评论服务存储与处理，您可参考其隐私政策。
- 数据统计：如接入第三方统计，仅用于分析访问量、来源等聚合信息，不用于识别个人身份。
...
五、您的权利
- 您有权了解本站收集与使用您信息的方式；
- 如您对数据使用有疑问、意见或需求（更正/删除），可通过留言板与我们联系。
